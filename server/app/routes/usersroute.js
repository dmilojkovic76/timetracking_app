    ...
    User.findOne({ email: req.body.email }, (err, user) => {
        ...
        if (!user) {
            ...
            if (user.password != req.body.password) {
                ...
                const payload = { email: user.email };  // kreiram payload samo sa emailom a ne celim korisnikom
...
router.post('/sign-up', (req, res) => {
    let user = new User(req.body); // kreiraj kopiju korisnika po prethodnom modelu, pa
